...
import { ILevel, ILogger } from '@quixo3/prisma-session-store/dist/@types/logger';
import { ISerializer } from '@quixo3/prisma-session-store/dist/@types/serializer';
/**
 ...
 */
export declare type TTLFactory = (options: IOptions, session: PartialDeep<SessionData>, sid: string) => number;
/**
